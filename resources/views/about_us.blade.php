...
@section("aboutUs")
    ...
    <!-- Блок О нас -->
    <div class="about_us">
        <h1>Welcome to Rentil</h1>

        <span>At Rentil, we are committed to providing you with a seamless and enjoyable car rental experience. With a diverse fleet of well-maintained vehicles and a dedication to exceptional customer service, we ensure that you find the perfect car for your needs.</span>
        ...
        <h3>Rentil – Drive with Confidence.</h3>
    </div>
@endsection